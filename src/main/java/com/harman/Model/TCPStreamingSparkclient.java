 ...
 *
 * Usage: JavaSqlNetworkWordCount <hostname> <port> <hostname> and
 * <port> describe the TCP server that Spark Streaming would connect to receive
 * data.
 *
 ...
 */
public final class TCPStreamingSparkclient {
